...
# --- Configuration ---
MAX_LENGTH = 120
DATA_DIR = "//Users/PeterMay/Downloads/amyloidosis/combined_80_20_seed3/train" # Corrected Path
SAVE_DIR = "paper_model_scalar_pathway_v1_minus5_stripped_80_20_seed3"  # Directory for this new run
N_SPLITS = 6
...
def prepare_data(data_dir, max_length, tokenizer, plm_model, device):
    ...
    for class_label, class_name in enumerate(["non_amyloid", "amyloid"]):
        ...
        # Group all files by base name, just like in prepare_test_data
        protein_files = {}
        ...
        for base_name, files in tqdm(protein_files.items(), desc=f"Processing {class_name}"):
            ...
            if not json_filename or not pdb_filename:
                # nothing usable for this base_name
                continue
