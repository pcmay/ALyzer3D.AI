...
SAVE_DIR = "paper_model_scalar_pathway_v1_minus5_stripped"
...
def prepare_test_data(data_dir, max_length, tokenizer, plm_model, device):
    ...
    for class_label, class_name in enumerate(["non_amyloid", "amyloid"]):
        ...
        for base_name, files in tqdm(protein_files.items(), desc=f"Processing {class_name}"):
            ...
            # --- MODIFICATION: match training (ignore last 5 residues) ---
            ...
            # Biochemical features: [pI, gravy, aromaticity, mol_weight]
            ...
            # Scalar summary features on full-length protein (kept for compatibility / analysis)
            ...
            # ADVANCED STRUCT: ONLY RoG (to match training scalar branch)
